...
const MODAL_TASK = 'taskModal';
const MODAL_COMMENT_FORM = 'commentFormModal';
...
const openTaskModal = function () {
    return openModal(MODAL_TASK);
};
const openCommentFormModal = function () {
    return openModal(MODAL_COMMENT_FORM);
};
const closeCommentFormModal = function () {
    return closeModal(MODAL_COMMENT_FORM);
};
const closeTaskModal = function () {
    return closeModal(MODAL_TASK);
};
