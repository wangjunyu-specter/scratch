...
import swiperIndexReducer, {taskSwiperIndexInitialState} from './swiper-index';
import commentFormDataReducer, {commentFormDataInitialState} from './comment-form';
...
const guiInitialState = {
    ...
    taskSwiperIndex: taskSwiperIndexInitialState,
    commentFormData: commentFormDataInitialState
};
...
const guiReducer = combineReducers({
    ...
    taskSwiperIndex: swiperIndexReducer,
    commentFormData: commentFormDataReducer
});
